...
\begin{figure}[H]
    ...
    \caption{Vista general del estudio 1}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{vlcsnap-2025-11-18-21h42m39s236.png}
    \caption{Vista general del estudio 2}
\end{figure}
\newpage
...
\begin{figure}[H]
    ...
    \caption{Vista general de la discoteca}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.45\textwidth}
        ...
        \caption{Modelo masculino}
    \end{minipage}
    \hfill
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{entrega4-screenshot-3.png}
        \caption{Modelo femenino}
    \end{minipage}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{entrega4-screenshot-4.png}
    \caption{Distribución del público en la discoteca}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{entrega4-screenshot-5.png}
        \caption{Audiencia en idle}
    \end{minipage}
    \hfill
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{entrega4-screenshot-6.png}
        \caption{Audiencia bailando}
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{entrega5-screenshot-4.png}
    \caption{Público bailando con la múscia en el club.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{entrega5-screenshot-5.png}
    \caption{Mano en el knob del filtro low/high-pass}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{entrega5-screenshot-2.png}
    \caption{Menú de selección/cambio de ambiente}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{entrega5-screenshot-6.png}
    \caption{Iluminación del club mejorada}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{entrega5-screenshot-3.png}
    \caption{Ambientación del club mejorada}
\end{figure}
...
\begin{itemize}
    ...
    \item Selector de canciones más descriptivo (nombre mejor formateado).
    \item Visualización e información del track seleccionado (portada, título, artista, album, bpm, key).
\end{itemize}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{entrega5-screenshot-8.png}
    \caption{Menú de selección de canciones mejorado}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{entrega5-screenshot-7.png}
    \caption{Visualizador de canción}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{entrega5-screenshot-1.png}
    \caption{Setup final}
\end{figure}